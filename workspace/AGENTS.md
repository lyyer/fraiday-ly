...
1. Read SOUL.md, USER.md, PROJECT_MAP.md, and today's memory files
...
## Post-File-Modification Protocol

**CRITICAL: After modifying ANY project-level file (e.g., `PROJECT_MAP.md`, `SOUL.md`, `AGENTS.md`, `USER.md`, `MEMORY.md`, or skill files), you MUST:**

1.  `git add <the_modified_file>`
2.  `git commit -m "Descriptive commit message for the change"`
