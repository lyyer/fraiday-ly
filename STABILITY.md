...
3. **The "Undo" Command:** Inform the user exactly what to run if I go offline.
4. **Validation:** After the change, immediately run `openclaw status` and verify tool access.
